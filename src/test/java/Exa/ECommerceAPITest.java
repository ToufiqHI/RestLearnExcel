...
public class ECommerceAPITest {
	...
	public static void main(String[] args)
		...
		logRequest.setUserEmail("rahulshetty@gmail.com");
		logRequest.setUserPassword("Iamking@000");


		RequestSpecification reqLogin = given().relaxedHTTPSValidation().log().all().spec(req).body(logRequest);
...
//	.multiPart("productImage",new File("/Users/amanbakshi/Desktop/Testimage.png"));
		...
		RequestSpecification createOrderBaseReq = new RequestSpecBuilder().setBaseUri("https://rahulshettyacademy.com")
				...
				.build();
		Orders.OrderDetail orderDetail = new Orders.OrderDetail();
		orderDetail.setCountry("India");
		orderDetail.setProductOrderedId(productId);

		List<Orders.OrderDetail> orderDetailList = new ArrayList<Orders.OrderDetail>();
